...
# 🔧 Tech Stack:
Frontend: Next.js, React, Svelte, Tailwind CSS, TanStack Query, HLS.js<br>Backend: Supabase, PostgreSQL, Node.js, Express, Prisma ORM, SQLite, JSON Web Token, Node-Media-Server, FFmpeg, Express<br>AI Tools: Claude AI, DeepSeek<br>APIs & Integrations: Google Flights, Skyscanner, Booking, Uber, OpenWeather, Pusher, Stripe<br>Hosting & Deployment: Vercel, Supabase Cloud<br><br>
# 🎯 Goal:
